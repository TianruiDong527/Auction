...
import { TenderlyForkContractUploadRequest, TenderlyVerifyContractsRequest } from "@tenderly/api-client/types";
export declare class TenderlyNetwork {
    ...
    verifyDevnetMultiCompilerAPI(request: TenderlyVerifyContractsRequest, tenderlyProject: string, username: string, devnetID: string): Promise<void>;
    ...
    setDevnetID(devnetID: string | undefined): void;
    private _writeHead;
