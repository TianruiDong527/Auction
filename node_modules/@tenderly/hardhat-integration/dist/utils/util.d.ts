...
import { TenderlyContract, TenderlyContractConfig, TenderlyVerifyContractsRequest } from "@tenderly/api-client/types";
import { ContractByName, Metadata } from "../tenderly/types";
export declare const makeVerifyContractsRequest: (hre: HardhatRuntimeEnvironment, flatContracts: ContractByName[], platformID?: string) => Promise<TenderlyVerifyContractsRequest | null>;
